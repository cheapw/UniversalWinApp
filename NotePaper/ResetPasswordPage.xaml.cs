...
namespace NotePaper
{
    ...
    public sealed partial class ResetPasswordPage : Page
    {
        ...
        {
            this.Frame.Navigate(typeof(RegisterPage), string.IsNullOrWhiteSpace(this.Email.Text) ? null : this.Email.Text, new SlideNavigationTransitionInfo() { Effect = SlideNavigationTransitionEffect.FromRight });
        }
